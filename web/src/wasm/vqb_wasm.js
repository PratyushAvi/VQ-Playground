 ...
 * @returns {string}
 */
export function list_primitives() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.list_primitives();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function list_quantizers() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.list_quantizers();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @param {Float32Array} _eval
 * @param {number} dim
 * @param {Uint32Array} candidates
 * @param {number} cand_width
 * @returns {string}
 */
export function run(config_json, base, _eval, dim, candidates, cand_width) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(config_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayF32ToWasm0(base, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArrayF32ToWasm0(_eval, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passArray32ToWasm0(candidates, wasm.__wbindgen_malloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.run(ptr0, len0, ptr1, len1, ptr2, len2, dim, ptr3, len3, cand_width);
        deferred5_0 = ret[0];
        deferred5_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {Uint32Array}
 */
export function top_neighbors(base, _eval, dim, l, on_progress) {
    const ptr0 = passArrayF32ToWasm0(base, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArrayF32ToWasm0(_eval, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.top_neighbors(ptr0, len0, ptr1, len1, dim, l, isLikeNone(on_progress) ? 0 : addToExternrefTable0(on_progress));
    if (ret[3]) {
 ...
 * @returns {string}
 */
export function validate_config(config_json, dim) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(config_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.validate_config(ptr0, len0, dim);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('vqb_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
